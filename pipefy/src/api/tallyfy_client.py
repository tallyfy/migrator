...
class TallyfyClient:
    ...
    def get_organization(self) -> Dict[str, Any]:
        ...
        return self._make_request('GET', f'/organizations/{self.organization_slug}')
    
    def update_organization(self, data: Dict[str, Any]) -> Dict[str, Any]:
        """Update organization settings"""
        return self._make_request('PATCH', f'/organizations/{self.organization_slug}', json=data)
    ...
    def update_step_instance(self, run_id: str, step_id: str, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        return self._make_request('PATCH', f'/runs/{run_id}/steps/{step_id}', json=data)
