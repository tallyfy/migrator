"""
Instance Transformer for Pipefy to Tallyfy Migration
...
class InstanceTransformer:
    """Transform Pipefy project instances to Tallyfy processes"""
    ...
    def transform_project(self, project: Dict[str, Any],
        ...
        """
        Transform a Pipefy project to Tallyfy process
        
        Args:
            project: Pipefy project instance
            template_mapping: Mapping of Pipefy template IDs to Tallyfy blueprint IDs
            user_mapping: Mapping of Pipefy user IDs to Tallyfy user IDs
    ...
    def _map_task_status(self, status: str) -> str:
        """Map Pipefy task status to Tallyfy status"""
        status_map = {
            'not_started': 'pending',
