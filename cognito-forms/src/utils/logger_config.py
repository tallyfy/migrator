"""
Logger Configuration for Cognito Forms Migration
...
def setup_logging(log_level: str = None, log_file: str = None):
    ...
    # Log initial setup
    root_logger.info("=" * 60)
    root_logger.info("Cognito Forms to Tallyfy Migration Started")
...
def configure_module_loggers():
    ...
    module_configs = {
        'api.cognito_forms_client': logging.DEBUG,
...
class APICallLogger:
    ...
    def __init__(self, api_name: str):
        ...
        Args:
            api_name: Name of the API (cognito_forms or tallyfy)
        """
