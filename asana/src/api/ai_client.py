"""
AI Client for Asana to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Asana migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Asana-specific thresholds (lower due to customer focus)
