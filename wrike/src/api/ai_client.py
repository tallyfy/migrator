"""
AI Client for Wrike to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Wrike migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Wrike-specific thresholds (lower due to customer focus)
