"""
AI Client for Typeform to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Typeform migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Typeform-specific thresholds (lower due to customer focus)
    ...
    def _fallback_field_mapping(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Typeform-specific field patterns
