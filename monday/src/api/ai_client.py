"""
AI Client for Monday.com to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Monday.com migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Monday.com-specific thresholds (lower due to customer focus)
    ...
    def _fallback_field_mapping(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Monday.com-specific field patterns
