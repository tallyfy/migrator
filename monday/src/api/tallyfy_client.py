"""Tallyfy API client for Monday.com migration."""
...
class TallyfyClient:
    ...
    def create_blueprint(self, name: str, description: str = '',
                        ...
                        kick_off_form: List[Dict] = None) -> Dict[str, Any]:
        ...
        Args:
            ...
            kick_off_form: Kick-off form fields
        ...
        if kick_off_form:
            data['kick_off_form'] = kick_off_form
