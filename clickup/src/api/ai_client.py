"""
AI Client for ClickUp to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for ClickUp migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # ClickUp-specific thresholds (lower due to customer focus)
    ...
    def _fallback_field_mapping(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # ClickUp-specific field patterns
