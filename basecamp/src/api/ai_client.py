"""
AI Client for Basecamp to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Basecamp migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Basecamp-specific thresholds (lower due to customer focus)
    ...
    def _fallback_field_mapping(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Basecamp-specific field patterns
