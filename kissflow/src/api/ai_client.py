"""
AI Client for Kissflow to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Kissflow migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Kissflow-specific thresholds (lower due to customer focus)
    ...
    def _fallback_field_mapping(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Kissflow-specific field patterns
