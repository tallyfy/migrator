"""
Logger Configuration for Jotform Migration
...
def setup_logging(log_level: str = None, log_file: str = None):
    ...
    # Log initial setup
    root_logger.info("=" * 60)
    root_logger.info("Jotform to Tallyfy Migration Started")
...
def configure_module_loggers():
    ...
    module_configs = {
        'api.jotform_client': logging.DEBUG,
...
class APICallLogger:
    ...
    def __init__(self, api_name: str):
        ...
        Args:
            api_name: Name of the API (jotform or tallyfy)
        """
