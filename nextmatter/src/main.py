#!/usr/bin/env python3
"""
NextMatter to Tallyfy Migration Orchestrator
...
from api.nextmatter_client import NextMatterClient
...
class NextMatterMigrationOrchestrator:
    """Orchestrates the 5-phase migration from NextMatter to Tallyfy"""
    ...
    def _generate_migration_id(self) -> str:
        ...
        return f"nextmatter_migration_{timestamp}"
    ...
    def run(self, dry_run: bool = False, resume: bool = False, phases: Optional[List[str]] = None):
        ...
        try:
            logger.info("=" * 80)
            logger.info(f"Starting NextMatter to Tallyfy Migration")
    ...
    def _run_discovery_phase(self) -> Dict[str, Any]:
        """Phase 1: Discover and catalog all NextMatter data"""
    ...
    def _run_mapping_phase(self, discovery_data: Dict[str, Any]) -> Dict[str, Any]:
        """Phase 2: Map NextMatter structures to Tallyfy concepts"""
    ...
    def _run_transformation_phase(self, discovery_data: Dict[str, Any], 
        ...
        """Phase 3: Transform NextMatter data to Tallyfy format"""
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description='NextMatter to Tallyfy Migration Tool')
    ...
    # Run migration
    orchestrator = NextMatterMigrationOrchestrator()
    orchestrator.run(
