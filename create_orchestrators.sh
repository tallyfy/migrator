...
# Create main.py orchestrators for all migrators
...
from api.${CLIENT_NAME} import ${VENDOR_NAME}Client
...
class ${VENDOR_NAME}MigrationOrchestrator:
    """Orchestrates the 5-phase migration from ${VENDOR_NAME} to Tallyfy"""
    ...
    def __init__(self):
        ...
        logger.info(f"${VENDOR_NAME} Migration Orchestrator initialized")
    ...
    def _initialize_components(self):
        ...
        self.vendor_client = ${VENDOR_NAME}Client()
    ...
    def _generate_migration_id(self) -> str:
        ...
        return f"${MIGRATOR}_migration_{timestamp}"
    ...
    def run(self, dry_run: bool = False, resume: bool = False, phases: Optional[List[str]] = None):
        ...
        try:
            logger.info("=" * 80)
            logger.info(f"Starting ${VENDOR_NAME} to Tallyfy Migration")
    ...
    def _run_discovery_phase(self) -> Dict[str, Any]:
        """Phase 1: Discover and catalog all ${VENDOR_NAME} data"""
        ...
        try:
            ...
            if not self.vendor_client.test_connection():
                raise Exception("Failed to connect to ${VENDOR_NAME}")
    ...
    def _run_mapping_phase(self, discovery_data: Dict[str, Any]) -> Dict[str, Any]:
        """Phase 2: Map ${VENDOR_NAME} structures to Tallyfy concepts"""
    ...
    def _run_transformation_phase(self, discovery_data: Dict[str, Any], 
        ...
        """Phase 3: Transform ${VENDOR_NAME} data to Tallyfy format"""
...
def main():
    """Main entry point"""
    parser = argparse.ArgumentParser(description='${VENDOR_NAME} to Tallyfy Migration Tool')
    ...
    # Run migration
    orchestrator = ${VENDOR_NAME}MigrationOrchestrator()
    orchestrator.run(
...
EOF
    ...
    echo "Created main.py for $MIGRATOR"
}

# Create orchestrators
create_main_py "wrike" "Wrike" "wrike_client"
create_main_py "nextmatter" "NextMatter" "nextmatter_client"
create_main_py "basecamp" "Basecamp" "basecamp_client"
create_main_py "jotform" "Jotform" "jotform_client"
create_main_py "cognito-forms" "CognitoForms" "cognito_forms_client"
create_main_py "trello" "Trello" "trello_client"

echo "Done creating orchestrators!"