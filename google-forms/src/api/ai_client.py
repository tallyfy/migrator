"""
AI Client for Google Forms to Tallyfy Migration
...
class AIClient:
    """AI-powered decision maker for Google Forms migration challenges"""
    ...
    def _fallback_form_complexity(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Google Forms-specific thresholds (lower due to customer focus)
    ...
    def _fallback_field_mapping(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Google Forms-specific field patterns
